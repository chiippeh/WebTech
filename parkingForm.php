...
<head>
    ...
    <script src="js/parkingForm.js" defer></script>
</head>
...
<body>
    ...
    <main class="center">
        <p>
            The closing date to apply for parking spot is 1 November 2027. If you have not submitted your application by this date then you will not be allocated a parking spot for 2028. It is up to you to
            ensure that your payment arrangements are cleared by the CFO before 1 January 2028, so that if a parking spot
            becomes available you can be allocated it.
        </p>
        <br>
        <p>
            Please note that you must indicate your preferred location otherwise any open spot will be allocated to you, so please
            indicate your preference clearly in the form below.
        </p>
        <br>
        <p>
            To cancel your application for a parking spot, please contact the CEO directly.
        </p>
        <br>
        <div id="errorMessages" ></div>
        <div class="bubble">
            <form action="#" onsubmit="return validateParking()">
                ...
                <label for="one">Journalism department</label><br>
                <input type="radio" id="two" name="seat" value="Two">
                <label for="two">Psychology department</label><br>
                <input type="radio" id="three" name="seat" value="Three">
                <label for="three">HKE department</label><br>
                <input type="radio" id="bench" name="seat" value="All">
                <label for="bench">Blue route</label><br>
                <input type="radio" id="bench" name="seat" value="All">
                <label for="bench">Eden Grove</label><br>
                <input type="radio" id="bench" name="seat" value="All">
                <label for="bench">Barrat</label><br><br>
        ...
        <p>
            Total cost of one (1) parking spot amounts to R17 382.64
        </p>
        <br>
    </main>
